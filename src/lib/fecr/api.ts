  ...
  constructor(api: apiType) {
    ...
    if (this.environment === "prod") {
      ...
      this.vouchersEndpoint =
        "https://api.comprobanteselectronicos.go.cr/recepcion/v1/"; // 'https://api.comprobanteselectronicos.go.cr/recepcion-sandbox/v1';
      this.authEndpoint =
        "https://idp.comprobanteselectronicos.go.cr/auth/realms/rut/protocol/openid-connect/token"; // 'https://idp.comprobanteselectronicos.go.cr/auth/realms/rut-stag/protocol/openid-connect/token';
      this.logoutEndpoint =
